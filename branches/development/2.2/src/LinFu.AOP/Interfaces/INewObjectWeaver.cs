...
namespace LinFu.AOP.Cecil.Interfaces
{
    ...
    public interface INewObjectWeaver : IHostWeaver<TypeDefinition>
    {
        ...
        /// <summary>
        /// Emits the necessary <paramref name="newInstructions"/> necessary to instantiate
        /// the <paramref name="concreteType"/>.
        /// </summary>
        /// <param name="hostMethod">The method that contains the activation request.</param>
        /// <param name="newInstructions">The list of instructions that will replace the existing instructions in the method body.</param>
        ...
        void EmitNewObject(MethodDefinition hostMethod, Queue<Instruction> newInstructions, MethodReference targetConstructor, TypeReference concreteType);
    }
}
