...
namespace LinFu.Persist.Metadata.Implementation
{
    ...
    /// </summary>
    [Implements(typeof(ITableRepositoryPersister),LifecycleType.Singleton)]
    public class DefaultTableRepositoryPersister : ITableRepositoryPersister
    {
        ...
        public void Save(ITableRepository repository)
        {
